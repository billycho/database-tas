...
/*  Created On : 15-Sep-2017 10:19:18 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Course_User]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Course] DROP CONSTRAINT [FK_Course_User]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Course_User_02]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Course] DROP CONSTRAINT [FK_Course_User_02]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_CourseParticipant_User]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [CourseParticipant] DROP CONSTRAINT [FK_CourseParticipant_User]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_EligibleParticipant_User]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [EligibleParticipant] DROP CONSTRAINT [FK_EligibleParticipant_User]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_TrainingPeriod_User]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [TrainingPeriod] DROP CONSTRAINT [FK_TrainingPeriod_User]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_TrainingPeriod_User_02]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [TrainingPeriod] DROP CONSTRAINT [FK_TrainingPeriod_User_02]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_User_Employee]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
...
CREATE NONCLUSTERED INDEX [IXFK_Course_User] 
 ON [Course] ([MainTrainerID] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Course_User_02] 
...
CREATE NONCLUSTERED INDEX [IXFK_CourseParticipant_User] 
 ON [CourseParticipant] ([UserID] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_EligibleParticipant_User] 
 ON [EligibleParticipant] ([UserID] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_TrainingPeriod_User] 
 ON [TrainingPeriod] ([CreatorID] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_TrainingPeriod_User_02] 
...
CREATE NONCLUSTERED INDEX [IXFK_User_Employee] 
 ON [User] ([EmployeeID] ASC)
GO
...
ALTER TABLE [Course] ADD CONSTRAINT [FK_Course_User]
	FOREIGN KEY ([MainTrainerID]) REFERENCES [User] ([UserID]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Course] ADD CONSTRAINT [FK_Course_User_02]
	FOREIGN KEY ([BackUpTrainerID]) REFERENCES [User] ([UserID]) ON DELETE No Action ON UPDATE No Action
GO
...
ALTER TABLE [CourseParticipant] ADD CONSTRAINT [FK_CourseParticipant_User]
...
ALTER TABLE [EligibleParticipant] ADD CONSTRAINT [FK_EligibleParticipant_User]
	FOREIGN KEY ([UserID]) REFERENCES [User] ([UserID]) ON DELETE No Action ON UPDATE No Action
GO
...
ALTER TABLE [TrainingPeriod] ADD CONSTRAINT [FK_TrainingPeriod_User]
	FOREIGN KEY ([CreatorID]) REFERENCES [User] ([UserID]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [TrainingPeriod] ADD CONSTRAINT [FK_TrainingPeriod_User_02]
	FOREIGN KEY ([UpdaterID]) REFERENCES [User] ([UserID]) ON DELETE No Action ON UPDATE No Action
GO
