...
/*  Created On : 15-Sep-2017 09:09:15 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_CourseName_CourseType]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [CourseName] DROP CONSTRAINT [FK_CourseName_CourseType]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_CourseParticipant_UserRole]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [CourseParticipant] DROP CONSTRAINT [FK_CourseParticipant_UserRole]
GO
...
CREATE NONCLUSTERED INDEX [IXFK_CourseName_CourseType] 
 ON [CourseName] ([CourseTypeID] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_CourseParticipant_UserRole] 
 ON [CourseParticipant] ([UserRoleID] ASC)
GO
...
ALTER TABLE [CourseName] ADD CONSTRAINT [FK_CourseName_CourseType]
	FOREIGN KEY ([CourseTypeID]) REFERENCES [CourseType] ([CourseTypeID]) ON DELETE No Action ON UPDATE No Action
GO
...
ALTER TABLE [CourseParticipant] ADD CONSTRAINT [FK_CourseParticipant_UserRole]
