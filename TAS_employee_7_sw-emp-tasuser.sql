...
/*  Created On : 26-Sep-2017 14:30:13 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Course_Employee]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Course] DROP CONSTRAINT [FK_Course_Employee]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Course_Employee_02]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Course] DROP CONSTRAINT [FK_Course_Employee_02]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_CourseParticipant_Employee]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [CourseParticipant] DROP CONSTRAINT [FK_CourseParticipant_Employee]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_EligibleParticipant_Employee]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [EligibleParticipant] DROP CONSTRAINT [FK_EligibleParticipant_Employee]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_TrainingPeriod_Employee]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [TrainingPeriod] DROP CONSTRAINT [FK_TrainingPeriod_Employee]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_TrainingPeriod_Employee_02]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [TrainingPeriod] DROP CONSTRAINT [FK_TrainingPeriod_Employee_02]
GO
...
CREATE NONCLUSTERED INDEX [IXFK_Course_Employee] 
 ON [Course] ([MainTrainerID] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Course_Employee_02] 
...
CREATE NONCLUSTERED INDEX [IXFK_CourseParticipant_Employee] 
 ON [CourseParticipant] ([EmployeeID] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_EligibleParticipant_Employee] 
 ON [EligibleParticipant] ([EmployeeID] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_TrainingPeriod_Employee] 
 ON [TrainingPeriod] ([CreatorID] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_TrainingPeriod_Employee_02] 
...
ALTER TABLE [Course] ADD CONSTRAINT [FK_Course_Employee]
	FOREIGN KEY ([MainTrainerID]) REFERENCES [Employee] ([EmployeeID]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Course] ADD CONSTRAINT [FK_Course_Employee_02]
...
ALTER TABLE [CourseParticipant] ADD CONSTRAINT [FK_CourseParticipant_Employee]
...
ALTER TABLE [EligibleParticipant] ADD CONSTRAINT [FK_EligibleParticipant_Employee]
	FOREIGN KEY ([EmployeeID]) REFERENCES [Employee] ([EmployeeID]) ON DELETE No Action ON UPDATE No Action
GO
...
ALTER TABLE [TrainingPeriod] ADD CONSTRAINT [FK_TrainingPeriod_Employee]
	FOREIGN KEY ([CreatorID]) REFERENCES [Employee] ([EmployeeID]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [TrainingPeriod] ADD CONSTRAINT [FK_TrainingPeriod_Employee_02]
	FOREIGN KEY ([UpdaterID]) REFERENCES [Employee] ([EmployeeID]) ON DELETE No Action ON UPDATE No Action
GO
